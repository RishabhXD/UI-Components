    ...
    <div className="flex items-center">
      ...
      <div className="relative">
        ...
        <div
          className={
            open
              ? "block absolute right-0 z-20 w-48 mt-2 overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800"
              : "hidden"
          }
        >
          <a
          ...
          >
            small{" "}
            <span className="text-gray-600 dark:text-gray-400">(640x426)</span>
          </a>
          <a
            href="#"
            className="block px-4 py-2 text-sm text-gray-800 transition-colors duration-300 transform border-b dark:text-gray-200 dark:border-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700"
